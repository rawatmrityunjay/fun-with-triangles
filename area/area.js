...
areaBtn.addEventListener("click", (e) => {
  ...
  if (
    ...
    secondSideValue > 0 &&
    thirdSideValue > 0 &&
    firstSideValue + secondSideValue > thirdSideValue && secondSideValue + thirdSideValue > firstSideValue && firstSideValue + thirdSideValue > secondSideValue
  ) {
    ...
    resultMsg.innerHTML = `The area of this triangle is : <span id="result-area">${area} sq.units</span>`;
